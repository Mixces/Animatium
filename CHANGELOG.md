...
- Fast Grass
- New Server Features: (all - enables everything, pick_inflation (inflates the pick radius to 0.1 like in <=1.8), clientside_entities (makes entity movement clientsided like in <=1.7))
