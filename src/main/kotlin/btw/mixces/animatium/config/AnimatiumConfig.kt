...
class AnimatiumConfig {
    ...
    @SerialEntry var debugHudTextColor = false
    @SerialEntry var persistentBlockOutline = false
    @SerialEntry var offhandUsageSwinging = false
    @SerialEntry var alwaysSharpParticles = false
    @SerialEntry var recipeAndTutorialToasts = false
    @SerialEntry var visibleArmWhileInvisible = false
    @SerialEntry var fakeMissPenaltySwing = false
    @SerialEntry var dontMoveBlueVoid = false
    @SerialEntry var usageSwingingParticles = false
    @SerialEntry var entityDeathTopple = true
    @SerialEntry var deepRedHurtTint = false
    @SerialEntry var particlePhysics = true
    @SerialEntry var firstPersonParticles = true
