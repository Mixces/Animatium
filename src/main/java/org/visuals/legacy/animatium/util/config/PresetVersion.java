...
public enum PresetVersion {
    V1_7(() -> {
        ...
        final ItemsConfigCategory items = AnimatiumConfig.instance().items;
        ...
        final OtherConfigCategory other = AnimatiumConfig.instance().other;
    ...
    PresetVersion(final Runnable applier) {
